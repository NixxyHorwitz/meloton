    ...
    <div style="display:flex;flex-direction:column;">
      ...
      <div class="m-card <?= $m_class ?>">
        ...
        <div class="m-specs">
          ...
          <div class="m-spec-full"><i class="ph-bold ph-trend-up"></i> Max. WD: <?= (float)$m['max_wd'] > 0 ? format_rp((float)$m['max_wd']) : '<span style="color:#10b981;font-weight:900">Tanpa batas</span>' ?></div>
